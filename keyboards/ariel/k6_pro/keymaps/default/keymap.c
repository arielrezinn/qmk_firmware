...
[MAC_BASE] = LAYOUT_ansi_68(
     ...
     LOPT_T(KC_GRV), KC_LCTL,  KC_LCMMD,                               KC_SPC,                       KC_RCMMD,MO(MAC_FN1),MO(FN2), KC_LEFT,  KC_DOWN, KC_RGHT),
...
[WIN_BASE] = LAYOUT_ansi_68(
     ...
     KC_LGUI,  KC_LCTL,  KC_LALT,                                KC_SPC,                       KC_RALT, MO(WIN_FN1),MO(FN2), KC_LEFT,  KC_DOWN, KC_RGHT),
